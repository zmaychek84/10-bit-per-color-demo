...
DEFINE_GUID(GUID_GrayscaleEffectPixelShader, 0xfddf597e, 0x98d4, 0x4aac, 0x83, 0x49, 0x6f, 0xb8, 0x36, 0x36, 0x36, 0x36);
DEFINE_GUID(CLSID_CustomGrayscaleEffect, 0x376c22b8, 0xe6c3, 0x41e7, 0xb1, 0xc1, 0xfb, 0x48, 0x48, 0x48, 0x48, 0x48);
...
class GrayscaleEffect : public ID2D1EffectImpl, public ID2D1DrawTransform
{
public:
    // Declare effect registration methods.
    static HRESULT Register(_In_ ID2D1Factory1* pFactory);

    static HRESULT __stdcall CreateGrayscaleEffectImpl(_Outptr_ IUnknown** ppEffectImpl);
